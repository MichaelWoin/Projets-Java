...
// --------------------------------------------------------------------------
    public int creer(Contact contact) throws SQLException, IOException, ClassNotFoundException
    {
        int rowCount;
        String insert;
...
// --------------------------------------------------------------------------
    public int modifier(Contact contact) throws SQLException, IOException, ClassNotFoundException
    {
        int rowCount;
        String update;
...
// --------------------------------------------------------------------------
    public int detruire(Contact contact) throws SQLException, IOException, ClassNotFoundException
    {
        int rowCount;
        String delete;
...
// --------------------------------------------------------------------------
    public Vector<Contact> lireListe(Secteur secteur) throws SQLException, IOException, ClassNotFoundException
    {
...
// Liste des contacts
// --------------------------------------------------------------------------
    public Vector<Contact> lireListe() throws SQLException, IOException, ClassNotFoundException
    {
        Vector<Contact> listeContacts;
        Contact contact;
